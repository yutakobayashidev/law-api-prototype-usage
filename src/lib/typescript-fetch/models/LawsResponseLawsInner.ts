 ...
 * 
 * @export
 * @interface LawsResponseLawsInner
 */
export interface LawsResponseLawsInner {
    /**
     * 
     * @type {LawInfo}
     * @memberof LawsResponseLawsInner
     */
    lawInfo?: LawInfo;
    /**
     * 
...
/**
 * Check if a given object implements the LawsResponseLawsInner interface.
 */
export function instanceOfLawsResponseLawsInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LawsResponseLawsInnerFromJSON(json: any): LawsResponseLawsInner {
    return LawsResponseLawsInnerFromJSONTyped(json, false);
}

export function LawsResponseLawsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): LawsResponseLawsInner {
    ...
    return {
        ...
        'currentRevisionInfo': !exists(json, 'current_revision_info') ? undefined : RevisionInfoFromJSON(json['current_revision_info']),
    };
}

export function LawsResponseLawsInnerToJSON(value?: LawsResponseLawsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'current_revision_info': RevisionInfoToJSON(value.currentRevisionInfo),
    };
}
